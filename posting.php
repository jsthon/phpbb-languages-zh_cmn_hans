...
$lang = array_merge($lang, array(
	'ADD_ATTACHMENT'			=> '上传附件',
	'ADD_ATTACHMENT_EXPLAIN'	=> '如果你要上传附件，请在下面填写详细信息。',
	'ADD_FILE'					=> '添加文件',
	'ADD_POLL'					=> '投票',
	'ADD_POLL_EXPLAIN'			=> '如果你不想在话题中添加投票，请不要填写以下内容。',
	...
	'BBCODE_S_HELP'				=> '字体颜色：[color=red]文本[/color]  提示：你也可以使用 color=#FF0000',
	'BBCODE_U_HELP'				=> '下划线：[u]文本[/u]',
	'BBCODE_W_HELP'				=> '插入链接：[url]http://url[/url] or [url=http://url]URL text[/url]',
	'BBCODE_Y_HELP'				=> '列表: 增加列表项',
	'BUMP_ERROR'				=> '你不能在发表后这么快就顶文章。',

	'CANNOT_DELETE_REPLIED'		=> '对不起，你只能删除尚无回复的话题。',
	'CANNOT_EDIT_POST_LOCKED'	=> '这篇帖子已经被锁定，你不能编辑它。',
	'CANNOT_EDIT_TIME'			=> '你不能再编辑或删除这篇帖子',
	'CANNOT_POST_ANNOUNCE'		=> '对不起，你不能发布公告。',
	'CANNOT_POST_STICKY'		=> '对不起，你不能发布置顶帖。',
	...
	'DELETE_FILE'				=> '删除文件',
	'DELETE_MESSAGE'			=> '删除消息',
	'DELETE_MESSAGE_CONFIRM'	=> '你确认要删除这个消息吗？',
	'DELETE_OWN_POSTS'			=> '对不起，你只能删除自己的帖子。',
	'DELETE_PERMANENTLY'		=> '永久删除',
	'DELETE_POST_CONFIRM'		=> '你确认要删除这篇帖子吗？',
	...
	'DRAFT_LOADED'				=> '草稿已经导入编辑区，你可以结束编辑你的帖子。<br />你的草稿将在帖子提交后删除。',
	'DRAFT_LOADED_PM'			=> '草稿已经导入编辑区域, 你可以现在完成你的私人短信.<br />你的草稿将在提交后删除.',
	'DRAFT_SAVED'				=> '草稿保存成功',
	'DRAFT_TITLE'				=> '草稿标题',

	'EDIT_REASON'				=> '编辑此贴的原因',
	'EMPTY_FILEUPLOAD'			=> '上传的是空文件',
	'EMPTY_MESSAGE'				=> '发贴时，你必须输入正文。',
	'EMPTY_REMOTE_DATA'			=> '文件上传失败，请尝试手动上传此文件。',

	'FLASH_IS_OFF'				=> '[flash] <em>禁止</em>',
	'FLASH_IS_ON'				=> '[flash] <em>允许</em>',
	'FLOOD_ERROR'				=> '你不能在这么短的时间内连续发表文章。',
	'FONT_COLOR'				=> '文字颜色',
	...
	'NOT_UPLOADED'				=> '文件上传失败。',
	'NO_DELETE_POLL_OPTIONS'	=> '你无法删除现有的投票选项',
	'NO_PM_ICON'				=> '没有 PM 图标',
	'NO_POLL_TITLE'				=> '你必须设置投票标题',
	'NO_POST'					=> '指定的文章不存在',
	...
	'POST_APPROVAL_NOTIFY'		=> '当你的文章通过审核时会通知你.',
	'POST_CONFIRMATION'			=> '文章确认',
	'POST_CONFIRM_EXPLAIN'		=> '为防止恶意灌水，本论坛要求你输入一组确认码。确认码显示在下面的图片中，如果你无法正常浏览这个图片请联络 %s论坛管理员%s。',
	...
	'POST_REVIEW_EDIT_EXPLAIN'	=> '在你编辑的过程中这篇文章已经被其他用户更改. 你可能需要查看一下新的帖子内容以便调整自己的发文.',
	'POST_REVIEW_EXPLAIN'		=> '已有至少一篇新回复在这个主题下发表了，你或许希望重新审视你的回贴。',
	...
	'SAVE_DATE'					=> '保存于',
	'SAVE_DRAFT'				=> '保存草稿',
	'SAVE_DRAFT_CONFIRM'		=> '请注意保存的草稿仅包含标题和正文，任何其他内容都将被忽略。你希望现在保存草稿吗?',
	'SMILIES'					=> '表情',
	...
	'TOO_FEW_CHARS'				=> '你输入的正文过短',
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> '你需要至少输入 %1$d 个字符。',
		2	=> '你需要至少输入 %1$d 个字符。',
	),
	'TOO_FEW_POLL_OPTIONS'		=> '你必须输入至少两个投票选项',
	'TOO_MANY_ATTACHMENTS'		=> '不能再添加更多的附件了，允许的数量是 %d 个。',
	'TOO_MANY_CHARS'			=> '你输入的正文过长',
	'TOO_MANY_CHARS_LIMIT'		=> array(
		2	=> '最大允许字符数是 %1$d。',
	),
	'TOO_MANY_POLL_OPTIONS'		=> '你输入了过多的投票选项',
	'TOO_MANY_SMILIES'			=> '你的内容包含了过多的表情，允许的最大表情数量是 %d。',
	'TOO_MANY_URLS'				=> '你的内容包含了过多的链接，允许的最大链接数量是 %d。',
	'TOO_MANY_USER_OPTIONS'		=> '你不能指定比当前选项数还多的每个用户可选数',
	'TOPIC_BUMPED'				=> '顶主题成功',

	'UNAUTHORISED_BBCODE'		=> '你不能使用特定的 BBCodes：%s',
	'UNGLOBALISE_EXPLAIN'		=> '要将这个主题从全局公告转换为普通主题，你需要选择一个版块放置它。',
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> '你的信息包括以下不支持的字符：<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> '你的主题包括以下不支持的字符：<br />%s',
	'UPDATE_COMMENT'			=> '更新评论',
	'URL_INVALID'				=> '你指定的链接无效。',
	'URL_NOT_FOUND'				=> '指定的文件无法找到。',
	'URL_IS_OFF'				=> '[url] <em>禁止</em>',
	'URL_IS_ON'					=> '[url] <em>允许</em>',
	'USER_CANNOT_BUMP'			=> '你不能在这个版块顶贴',
	'USER_CANNOT_DELETE'		=> '你不能在这个版块删除帖子',
	'USER_CANNOT_EDIT'			=> '你不能在这个版块编辑帖子',
	'USER_CANNOT_REPLY'			=> '你不能在这个版块回复主题',
	'USER_CANNOT_FORUM_POST'	=> '你不能在这个版块进行发帖操作，因为这个版块类型不支持。',

	'VIEW_MESSAGE'				=> '%s查看你提交的内容%s',
	'VIEW_PRIVATE_MESSAGE'		=> '%s查看你发送的私人短信%s',

	'WRONG_FILESIZE'			=> '文件太大了, 最大允许文件尺寸为 %1$d %2$s',
	'WRONG_SIZE'				=> '图片必须最小宽 %1$s 象素，高 %2$s 象素；最大宽 %3$s 象素，高 %4$s 象素。你提交的图片为：宽 %5$s 象素，高 %6$s 象素。',
));
