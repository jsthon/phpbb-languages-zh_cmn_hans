...
$lang = array_merge($lang, array(
	...
	'ACTION_NOTE'			=> '操作/提示',
	'ADD_FEEDBACK'			=> '添加反馈',
	'ADD_FEEDBACK_EXPLAIN'	=> '如果你需要添加一个报告，请填写下列表格。只可使用纯文本，不允许HTML， BBCode等语法。',
	'ADD_WARNING'			=> '发出警告',
	'ADD_WARNING_EXPLAIN'	=> '要对此用户发出一个警告，请填写下列表格。只可使用纯文本，不允许HTML， BBCode等语法。',
	'ALL_ENTRIES'			=> '所有条目',
	'ALL_NOTES_DELETED'		=> '成功删除所有用户消息',
	'ALL_REPORTS'			=> '全部举报',
	'ALREADY_REPORTED'		=> '该帖子已经被举报过了',
	'ALREADY_REPORTED_PM'	=> '该私信已经被举报过了.',
	'ALREADY_WARNED'		=> '该帖子已经被警告过了',
	'APPROVE'				=> '审核通过',
	'APPROVE_POST'			=> '帖子审核通过',
	'APPROVE_POST_CONFIRM'	=> '你确定要审核通过此帖子发布吗？',
	'APPROVE_POSTS'			=> '帖子审核通过',
	'APPROVE_POSTS_CONFIRM'	=> '你确定要审核通过这些帖子发布吗？',
	'APPROVE_TOPIC'			=> '主题审核通过',
	'APPROVE_TOPIC_CONFIRM'	=> '你确定要审核通过此主题吗？',
	'APPROVE_TOPICS'		=> '主题审核通过',
	'APPROVE_TOPICS_CONFIRM'=> '你确定要审核通过所选主题吗？',

	'CANNOT_MOVE_SAME_FORUM'=> '你不能将主题移动到它当前所在的版块内',
	'CANNOT_WARN_ANONYMOUS'	=> '你不能警告尚未注册的访客',
	'CANNOT_WARN_SELF'		=> '你不能警告你自己',
	'CAN_LEAVE_BLANK'		=> '此为选填内容。',
	'CHANGE_POSTER'			=> '改变作者',
	'CLOSE_PM_REPORT'		=> '关闭举报',
	'CLOSE_PM_REPORT_CONFIRM'	=> '你确定要关闭这个举报吗？',
	'CLOSE_PM_REPORTS'		=> '关闭举报',
	'CLOSE_PM_REPORTS_CONFIRM'	=> '你确定要关闭这些举报吗？',
	'CLOSE_REPORT'			=> '关闭举报',
	'CLOSE_REPORT_CONFIRM'	=> '你确定要关闭这个举报吗？',
	'CLOSE_REPORTS'			=> '关闭举报',
	'CLOSE_REPORTS_CONFIRM'	=> '你确定要关闭这些举报吗？',

	'DELETE_PM_REPORT'			=> '删除举报',
	'DELETE_PM_REPORT_CONFIRM'	=> '你确定要删除这个举报吗？',
	'DELETE_PM_REPORTS'			=> '删除举报',
	'DELETE_PM_REPORTS_CONFIRM'	=> '你确定要删除这些举报吗？',
	'DELETE_POSTS'				=> '删除帖子',
	'DELETE_REPORT'				=> '删除举报',
	'DELETE_REPORT_CONFIRM'		=> '你确定要删除这个举报吗？',
	'DELETE_REPORTS'			=> '删除举报',
	'DELETE_REPORTS_CONFIRM'	=> '你确定要删除这些举报吗？',
	'DELETE_SHADOW_TOPIC'		=> '删除影子主题',
	'DELETE_TOPICS'				=> '删除选定主题',
	'DISAPPROVE'				=> '禁止发布',
	'DISAPPROVE_REASON'			=> '禁止发布的理由',
	'DISAPPROVE_POST'			=> '禁发此贴',
	'DISAPPROVE_POST_CONFIRM'	=> '你确定要禁止此贴发布吗？',
	'DISAPPROVE_POSTS'			=> '禁发这些帖子',
	'DISAPPROVE_POSTS_CONFIRM'	=> '你确定要禁止这些帖子发布吗？',
	'DISPLAY_LOG'				=> '显示记录',
	'DISPLAY_OPTIONS'			=> '显示选项',

	'EMPTY_REPORT'					=> '选择这个理由时你必须手动输入描述',
	'EMPTY_TOPICS_REMOVED_WARNING'	=> '请注意一个或多个主题因为内容为空已经从数据库中删除',

	'FEEDBACK'				=> '反馈',
	'FORK'					=> '复制',
	'FORK_TOPIC'			=> '复制主题',
	'FORK_TOPIC_CONFIRM'	=> '你确认要复制这个主题吗？',
	'FORK_TOPICS'			=> '复制选中的主题',
	'FORK_TOPICS_CONFIRM'	=> '你确认要复制这些主题吗？',
	'FORUM_DESC'			=> '版块简介',
	'FORUM_NAME'			=> '版块名称',
	'FORUM_NOT_EXIST'		=> '你选择的版块不存在',
	'FORUM_NOT_POSTABLE'	=> '你选择的版块不能发帖',
	'FORUM_STATUS'			=> '版块状态',
	'FORUM_STYLE'			=> '版块风格',
	...
	'LATEST_LOGS'				=> '近期操作记录',
	'LATEST_REPORTED'			=> '近期内容举报',
	'LATEST_REPORTED_PMS'		=> '近期私信举报',
	'LATEST_UNAPPROVED'			=> '待审核的帖子',
	'LATEST_WARNING_TIME'		=> '最近发出的警告',
	'LATEST_WARNINGS'			=> '近期的警告记录',
	'LEAVE_SHADOW'				=> '保留影子主题',
	'LIST_REPORTS'				=> array(
		1	=> '%d 报告',
		2	=> '%d 报告',
	...
	'LOCK'						=> '锁定',
	'LOCK_POST_POST'			=> '锁定此贴',
	'LOCK_POST_POST_CONFIRM'	=> '你确定要禁止对此贴的编辑操作吗？',
	'LOCK_POST_POSTS'			=> '锁定这些帖子',
	'LOCK_POST_POSTS_CONFIRM'	=> '你确定要禁止对这些帖子的编辑操作吗？',
	'LOCK_TOPIC_CONFIRM'		=> '你确定要锁定这个主题吗？',
	'LOCK_TOPICS'				=> '锁定这些主题',
	'LOCK_TOPICS_CONFIRM'		=> '你确定要锁定这些主题吗？',
	'LOGS_CURRENT_TOPIC'		=> '正在查看日志:',
	'LOGIN_EXPLAIN_MCP'			=> '你必须登录后才能管理这个版块。',
	'LOGVIEW_VIEWTOPIC'			=> '查看主题',
	'LOGVIEW_VIEWLOGS'			=> '查看主题日志',
	'LOGVIEW_VIEWFORUM'			=> '查看版块',
	'LOOKUP_ALL'				=> '检索所有IP地址',
	'LOOKUP_IP'					=> '检索IP地址',
	...
	'MCP_LOGS'						=> '版主日志',
	'MCP_LOGS_FRONT'				=> '首页',
	'MCP_LOGS_FORUM_VIEW'			=> '版块相关记录',
	'MCP_LOGS_TOPIC_VIEW'			=> '主题相关记录',

	'MCP_MAIN'						=> '主要信息',
	'MCP_MAIN_FORUM_VIEW'			=> '查看版块',
	'MCP_MAIN_FRONT'				=> '首页',
	'MCP_MAIN_POST_DETAILS'			=> '帖子详细内容',
	'MCP_MAIN_TOPIC_VIEW'			=> '查看主题',
	'MCP_MAKE_ANNOUNCEMENT'			=> '改变为 “公告”',
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> '你确定要将这个主题改变为 “公告”吗？',
	'MCP_MAKE_ANNOUNCEMENTS'		=> '改变为 “公告”',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'=> '你确定要将这些主题改变为 “公告” 吗？',
	'MCP_MAKE_GLOBAL'				=> '改变为 “全局公告”',
	'MCP_MAKE_GLOBAL_CONFIRM'		=> '你确定要将这个主题改变为 “全局公告” 吗？',
	'MCP_MAKE_GLOBALS'				=> '改变为 “全局公告”',
	'MCP_MAKE_GLOBALS_CONFIRM'		=> '你确定要将这些主题改变为 “全局公告” 吗？',
	'MCP_MAKE_STICKY'				=> '改变为 “置顶”',
	'MCP_MAKE_STICKY_CONFIRM'		=> '你确定要将这个主题改变为 “置顶” 吗？',
	'MCP_MAKE_STICKIES'				=> '改变为 “置顶”',
	'MCP_MAKE_STICKIES_CONFIRM'		=> '你确定要将这些主题改变为 “置顶” 吗？',
	'MCP_MAKE_NORMAL'				=> '改变为 “普通主题”',
	'MCP_MAKE_NORMAL_CONFIRM'		=> '你确定要将这个主题改变为 “普通主题” 吗？',
	'MCP_MAKE_NORMALS'				=> '改变为 “普通主题”',
	'MCP_MAKE_NORMALS_CONFIRM'		=> '你确定要将这些主题改变为 “普通主题” 吗？',
	...
	'MCP_PM_REPORTS_CLOSED'			=> '已处理的私信举报',
	'MCP_PM_REPORTS_CLOSED_EXPLAIN'	=> '这是已经处理过的私信举报列表.',
	'MCP_PM_REPORTS_OPEN'			=> '待审查的私信举报',
	'MCP_PM_REPORTS_OPEN_EXPLAIN'	=> '这是等待处理的私信举报列表.',

	'MCP_REPORTS'					=> '查看举报',
	'MCP_REPORT_DETAILS'			=> '举报详细内容',
	'MCP_REPORTS_CLOSED'			=> '已处理的举报',
	'MCP_REPORTS_CLOSED_EXPLAIN'	=> '这是已经处理过的帖子举报列表',
	'MCP_REPORTS_OPEN'				=> '待审查的举报',
	'MCP_REPORTS_OPEN_EXPLAIN'		=> '这是等待处理的帖子举报列表',

	'MCP_QUEUE'								=> '审核队列',
	'MCP_QUEUE_APPROVE_DETAILS'				=> '批复说明',
	'MCP_QUEUE_UNAPPROVED_POSTS'			=> '待审核帖子',
	'MCP_QUEUE_UNAPPROVED_POSTS_EXPLAIN'	=> '这是需要批准后才对用户可见的帖子列表',
	'MCP_QUEUE_UNAPPROVED_TOPICS'			=> '待审核主题',
	...
	'MERGE_POSTS_CONFIRM'	=> '你确定你想要移动已选中的帖子吗？',
	'MERGE_TOPIC_EXPLAIN'	=> '使用下面的表单你可以将选中的帖子移动到另一个主题中。这些帖子将从这个主题分离然后合并到另一个主题。这些帖子不会被记录，就像用户将其发表在一个新主题中一样。<br />请输入目标主题ID或者点击 "选择主题" 来找一个。',
	'MERGE_TOPIC_ID'		=> '目标主题ID号',
	'MERGE_TOPICS'			=> '合并主题',
	'MERGE_TOPICS_CONFIRM'	=> '你确认要合并选中的主题吗？',
	'MODERATE_FORUM'		=> '管理版块',
	'MODERATE_TOPIC'		=> '管理主题',
	'MODERATE_POST'			=> '管理帖子',
	'MOD_OPTIONS'			=> '版主选项',
	...
	'MOVE_TOPIC_CONFIRM'	=> '你确认将主题移动到新版块吗？',
	'MOVE_TOPICS'			=> '移动选中的主题',
	'MOVE_TOPICS_CONFIRM'	=> '你确认将这些主题移动到新版块吗？',

	'NOTIFY_POSTER_APPROVAL'		=> '通知作者关于通过批准的信息吗？',
	'NOTIFY_POSTER_DISAPPROVAL'		=> '通知作者关于未通过批准的信息吗？',
	'NOTIFY_USER_WARN'				=> '通知用户关于警告的信息吗？',
	'NOT_MODERATOR'					=> '你不是这个版块的版主',
	'NO_DESTINATION_FORUM'			=> '请选择一个版块作为目标',
	'NO_DESTINATION_FORUM_FOUND'	=> '没有可用的目标版块.',
	'NO_ENTRIES'					=> '没有记录',
	'NO_FEEDBACK'					=> '没有这个用户的反馈',
	'NO_FINAL_TOPIC_SELECTED'		=> '你必须选中一个主题作为合并帖子的目标',
	'NO_MATCHES_FOUND'				=> '没有找到匹配的结果',
	'NO_POST'						=> '你必须选中一个帖子作为警告用户的根据',
	'NO_POST_REPORT'				=> '这个帖子没有被举报.',
	'NO_POST_SELECTED'				=> '你必须选中一个或更多的帖子来完成这项操作',
	'NO_POSTS_DELETED'				=> '没有删除的帖子。',
	'NO_POSTS_QUEUE'				=> '没有等待批准的帖子。',
	'NO_REASON_DISAPPROVAL'			=> '请输入一个合理的陈述作为不予批准的理由',
	'NO_REPORT'						=> '没有找到举报',
	'NO_REPORTS'					=> '没有找到举报',	
	'NO_REPORT_SELECTED'			=> '你必须选择至少一个举报来完成这个操作.',
	'NO_TOPIC_ICON'					=> '空',
	'NO_TOPIC_SELECTED'				=> '你必须选择至少一个主题来完成这个操作',
	...
	'PM_REPORT_CLOSED_SUCCESS'	=> '举报被成功处理完成。',
	'PM_REPORT_DELETED_SUCCESS'	=> '举报被成功删除。',
	'PM_REPORTED_SUCCESS'		=> '站内私信举报发送成功。',
	...
	'REPORT_MESSAGE_EXPLAIN'	=> '使用这个表单来向论坛管理员举报选中的内容. 举报一般用于违反版块规则的情况. <strong>注意: 举报私信将使内容对于版主和管理员可见</strong>',
	'REPORT_NOTIFY'				=> '通知',
	'REPORT_NOTIFY_EXPLAIN'		=> '举报处理完成后向你发送通知。',
	'REPORT_POST_EXPLAIN'		=> '告诉我们你发现的违规内容。',
	'REPORT_REASON'				=> '举报理由',
	'REPORT_TIME'				=> '举报时间',
	'RESTORE'					=> '恢复',
	'RESTORE_POST'				=> '恢复帖子',
	...
	'SELECT_ACTION'						=> '选择操作',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> '请选择你希望显示全局公告的版块.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> '一个或多个选中的主题是全局公告. 请选择你希望这些公告出现的版块.',
	'SELECT_MERGE'						=> '选择合并',
	...
	'SPLIT_TOPIC_ALL_CONFIRM'			=> '你确认分割这个主题吗？',
	'SPLIT_TOPIC_BEYOND'				=> '分割选中的帖子为新主题',
	'SPLIT_TOPIC_BEYOND_CONFIRM'		=> '你确认要分割这个主题吗？',
	'SPLIT_TOPIC_EXPLAIN'				=> '使用下面的表单你可以将一个主题分割为两个, 可以分割选中帖子也可以分割未选中的帖子',

	'THIS_PM_IP'				=> '这个站內私信的IP地址',
	...
	'UNLOCK_POST_POST_CONFIRM'		=> '你确定要允许对此贴的编辑操作吗？',
	'UNLOCK_POST_POSTS'				=> '解锁这些帖子',
	'UNLOCK_POST_POSTS_CONFIRM'		=> '你确定要允许对这些帖子的编辑操作吗？',
	'UNLOCK_TOPIC'					=> '解锁此主题',
	'UNLOCK_TOPIC_CONFIRM'			=> '你确定要解除对这个主题的锁定吗？',
	'UNLOCK_TOPICS'					=> '解锁这些主题',
	'UNLOCK_TOPICS_CONFIRM'			=> '你确定要解除对这些主题的锁定吗？',
	'USER_CANNOT_POST'				=> '你不能在这个版块发贴',
	'USER_CANNOT_REPORT'			=> '你不能在这个版块举报帖子',
	...
	'WARNING_PM_BODY'		=> '以下是这个论坛的管理员或版主对你的警告[quote]%s[/quote]',
	'WARNING_PM_SUBJECT'	=> '论坛警告标题',
	'WARNING_POST_DEFAULT'	=> '这个警告是由于以下你发表的帖子: %s .',
	'NO_WARNINGS'	=> '没有警告存在。',

	'YOU_SELECTED_TOPIC'	=> '你选择了主题编号 %d: %s',
